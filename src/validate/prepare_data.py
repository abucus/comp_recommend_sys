...
def prepare_pimf_validation_data(base_path = op.join("..","..","output","data2","validate","pimf")):
...
if __name__ == '__main__':
    prepare_pimf_validation_data(base_path = op.join("..","..","output","data2","validate","pimf"))